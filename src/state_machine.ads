...
package State_Machine is
   ...
   function Transition (M : in out Machine; To : App_State; Log : in out Errors.Error_Log) return Status_Code;
   ...
   function Transition_Count (M : Machine) return Medium_Natural;
private
