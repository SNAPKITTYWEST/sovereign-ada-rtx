...
package Parser is
   ...
   function Parse_Line (Line : String; Cmd : out Parsed_Command; Log : in out Errors.Error_Log) return Status_Code;
   ...
   function Command_Requires_Args (C : Command_Id) return Boolean;
end Parser;
