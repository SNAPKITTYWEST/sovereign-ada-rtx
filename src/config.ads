...
package Config is
   ...
   function Set_Value (Cfg : in out Configuration; Key : Config_Key; Value : Word32; Log : in out Errors.Error_Log) return Status_Code;
   function Get_Value (Cfg : Configuration; Key : Config_Key; Value : out Word32) return Status_Code;
   ...
   function Count_Set_Entries (Cfg : Configuration) return Natural;
private
